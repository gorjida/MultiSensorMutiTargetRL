...
if __name__=="__main__":
    ...
    weight = np.array([[  7.8298383 ,  10.37983478,   3.35204969,   9.91446941,
         -2.84844313, -13.96745699],
       [-14.93342663,   9.27361261,  -4.04988106,   0.17954491,
         12.16543779,  -4.48418833]])

    #weight = np.array([[  8.82585926,   6.11033838,   1.34612288,   2.95224077,
     #    -0.72904048, -11.03932284],
      # [-10.81339082,   1.80644165,  -7.5724417 ,   2.75471144,
       #   8.06173576,  -0.80639716]])
    ...
    while episode_counter<N_max:
        ...
        t = target(init_target_state[0:2], init_target_state[2], init_target_state[3], .001, .001, "CONS_V")#constant-velocity model for target motion
