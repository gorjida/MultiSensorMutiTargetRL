...
if __name__=="__main__":
    ...
    p = Pool(15)
    experiment_folder_name = "linear_policy_discrete_reward_final_with_barrier_VMAX1000"
    ...
    job_args = [(method,RBF_components,MLP_neurons,i,experiment_folder_name,vel_var,v_max) for i in range(0,15)]
    #run(job_args[0])
    p.map(run,job_args)
