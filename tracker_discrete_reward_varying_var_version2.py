...
if __name__=="__main__":
    ...
    p = Pool(15)
    experiment_folder_name = "linear_policy_discrete_reward_final_varying_var_version2"
    ...
    job_args = [(method,RBF_components,MLP_neurons,i,experiment_folder_name,vel_var) for i in range(0,15)]
    p.map(run,job_args)
