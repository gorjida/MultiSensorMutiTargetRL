...
class Track_Cluster:
    ...
    def mean_measurements(self,measurements):return (np.mean(measurements,axis=0))
    ...
    def sample_cov_unweighted(self,measurements):return (np.cov(measurements.transpose()))
    def sample_cov_weighted(self,measurements):return (np.cov(measurements.transpose(),aweights=self.snrs))
